...
String pwd=request.getParameter("pass");
	 ...
	 String username=name+q;
		...
		p11.setContent("<pre>Your username for PERP (Performance Evaluation and Recruitment Portal is"+username+ " , you can login your username and password</pre>" , "text/html");
		...
		int nora=s.executeUpdate("insert into user_info values"+
		          "( '"+username+"','"+name+"','"+age+"','"+gen+"','"+email+"','"+pwd+"')");
