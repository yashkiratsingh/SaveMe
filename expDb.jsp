...
<body><%response.setHeader("Cache-Control", "no-cache, no-store,must-revalidate"); %>
	<div class="nav">
		<pre>SaveMe</pre>
		<ul>
			<li><a href="Logout.jsp?ii=2">Log Out</a></li>
		</ul>
	</div>
	<div class="sidebar">
		<ul>
	...
	<div class="main">
		...
		<div id="Menu2" style="display: none">
			...
			<%
				...
				String Id = "Null";
				ResultSet rs3 = st1.executeQuery("select Id from exp_info where email='" + em + "'");
				if (rs3.next()) {
					Id = rs3.getString("Id");
				}
				session.setAttribute("Id", Id);
				ResultSet rs2 = st1.executeQuery("select * from ques where advisorId='" + Id + "' and solution =\"NA\"");
				int i=1;
				while (rs2.next()) {
					String ans = rs2.getString("solution");
					String qId=rs2.getString("quesid");
			%>
			...
			<table border="2px" bordercolor="white" cellspacing="5px"
				...
				<tr>
					<td>Status:</td>
					<td><a href="Solving.jsp?id=<%=qId%>" >Answer it</a>
				</tr>
